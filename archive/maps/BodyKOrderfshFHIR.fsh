...
* status = #draft
* experimental = true
* description = "CZ K-order Body (A.2-A.6) to FHIR mapping for ServiceRequest, Condition, DocumentReference, Provenance and Composition sections."
...
* group[=].element[=].target[0].code = #KOrderServiceRequestCz
...
* group[=].element[=].target[0].code = #KOrderServiceRequestCz.identifier
* group[=].element[=].target[0].display = ""
* group[=].element[=].target[0].equivalence = #equivalent
///////////////////////////////////////////////////////////////////////////////
...
* group[=].element[=].target[0].code = #KOrderServiceRequestCz.authoredOn
* group[=].element[=].target[0].display = ""
* group[=].element[=].target[0].equivalence = #equivalent
///////////////////////////////////////////////////////////////////////////////
...
* group[=].element[=].target[0].code = #KOrderServiceRequestCz.occurrenceDateTime
* group[=].element[=].target[0].display = ""
* group[=].element[=].target[0].equivalence = #equivalent
///////////////////////////////////////////////////////////////////////////////
...
* group[=].element[=].target[0].code = #KOrderServiceRequestCz.priority
* group[=].element[=].target[0].display = ""
* group[=].element[=].target[0].equivalence = #equivalent
///////////////////////////////////////////////////////////////////////////////
...
* group[=].element[=].target[0].code = #ServiceRequest.note.text
* group[=].element[=].target[0].equivalence = #equivalent
///////////////////////////////////////////////////////////////////////////////
...
* group[=].element[+].code = #zavaznaAnamnestickaData
* group[=].element[=].display = "Závažná anamnestická data"
* group[=].element[=].target.code = #section[significantMedicalHistory].text
* group[=].element[=].target.display = "Composition.section (significantMedicalHistory).text"
* group[=].element[=].target.equivalence = #equivalent

* group[=].element[+].code = #vysledkyVysetreni
* group[=].element[=].display = "Výsledky vyšetření"
* group[=].element[=].target.code = #section[examinationResults].text
* group[=].element[=].target.display = "Composition.section (examinationResults).text"
* group[=].element[=].target.equivalence = #equivalent

* group[=].element[+].code = #diferencialniDiagnostickaRozvaha
* group[=].element[=].display = "Diferenciální diagnostická rozvaha"
* group[=].element[=].target.code = #section[differentialDiagnosis].text
* group[=].element[=].target.display = "Composition.section (differentialDiagnosis).text"
* group[=].element[=].target.equivalence = #equivalent

* group[=].element[+].code = #soucasnaLecba
* group[=].element[=].display = "Současná léčba"
* group[=].element[=].target.code = #section[currentTreatment].text
* group[=].element[=].target.display = "Composition.section (currentTreatment).text"
* group[=].element[=].target.equivalence = #equivalent

* group[=].element[+].code = #zapujcenaDokumentace
* group[=].element[=].display = "Zapůjčená dokumentace"
* group[=].element[=].target.code = #section[referencedDocumentation].text
