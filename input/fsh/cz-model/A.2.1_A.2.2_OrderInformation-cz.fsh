Logical: LMCzOrderInformationCz
Id: LMOrderInformationCz
...
* detailyObjednavky.identifikator 1..* Identifier "A.2.1.1 - ID objednávky" """Identifikátor objednávky vyšetření."""
* detailyObjednavky.datumACas 1..1 dateTime "A.2.1.2 - Datum a čas objednávky" """Datum a čas zadání objednávky."""
* detailyObjednavky.datumACasPozadovanehoProvedeni 0..1 dateTime "A.2.1.3 - Datum a čas požadovaného provedení" """Datum a čas požadovaného provedení."""
* detailyObjednavky.urgentnost 1..1 CodeableConcept "A.2.1.4 - Naléhavost požadavku / urgentnost objednávky" """Naléhavost požadavku, resp. urgentnost objednávky (rutinní, urgentní, statim).
...
* detailyObjednavky.informaceProPacienta 0..1 string "A.2.1.6 - Informace pro pacienta" """Instrukce pro pacienta související s objednávkou. Např. nalačno apod."""
