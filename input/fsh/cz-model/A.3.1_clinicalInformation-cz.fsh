...
* dalsiRelevantniKlinickeInformace.kod 0..* CodeableConcept "A.3.1.2.1 - Kód informace / jiné diagnóza" """ Diagnózy a jiné kódované klinické informace důležité pro provedení žádanky nebo interpretaci výsledků."""
