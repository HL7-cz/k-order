Logical: LMCzDigitalSignatureOrderCz
Id: LMDigitalSignatureOrderCz
...
* elektronickyPodpis 1..1 Signature "A.1.9.1 - Elektronický podpis" """Elektronický podpis nebo pečeť dokumentu."""
