Logical: LMEnOrderInformationCz				
Id: LMEnOrderInformationCz
Title: "A.2.1 - Order information and A.2.2 - Order reason"				
Description:  """Information about order and order reason"""		

* insert SetFmmandStatusRule( 1, draft)	

* orderDetails 0..* Base "A.2.1.1 - Order information" """Order information could respond to multiple test orders """				
* orderDetails.identifier 1..* Identifier "A.2.1.1.1 - Order Id" """An identifier of the K-order."""				
* orderDetails.dateTime 1..1 dateTime "A.2.1.1.2 - Order date and time" """Date and time of the order placement."""		 		
* orderDetails.requestedExecdateTime 0..1 dateTime "A.2.1.1.3 - Date and time of requested execution" """Date and time of requested execution"""				
* orderDetails.urgency 0..1 CodeableConcept "A.2.1.1.4 - Urgency of the order" """Urgency of the order (routine, urgent, statim). Preferred system(s): HL7:RequestPriority"""				
...
* reimbursementCode 0..1 CodeableConcept "A.2.1.3 - Reimbursement code"
