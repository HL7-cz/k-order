...
* hlavicka 1..1 LMHeaderOrder
  ...
  """Hlavička K žádanky obsahující identifikaci subjektů, administrativní údaje a metadata dokumentu."""

* telo 1..1 LMBodyKOrder
  "A.2 a A.3 - Tělo dokumentu"
  """Tělo K žádanky obsahující informace o objednávce, klinickém kontextu a požadovaných vyšetřeních nebo službách."""
...
* prilohy 0..* LMAttachmentsOrderCz
  "A.5 - Přílohy"
  """Další přílohy a doplňující soubory připojené ke K žádance."""
