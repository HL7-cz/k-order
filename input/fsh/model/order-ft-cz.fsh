...
* hlavicka 1..1 LMHeaderOrder
  ...
  """Hlavička FT žádanky obsahující identifikaci subjektů, administrativní údaje a metadata dokumentu."""

* telo 1..1 LMBodyFTOrder
  "A.2 a A.3 - Tělo dokumentu"
  """Tělo FT žádanky obsahující informace o objednávce, klinickém kontextu a požadovaných FT výkonech nebo službách."""
...
* prilohy 0..* LMAttachmentsOrderCz
  "A.5 - Přílohy"
  """Další přílohy a doplňující soubory připojené k FT žádance."""
